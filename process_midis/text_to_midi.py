...
def text_to_chords(filename, text):
    if not verify_text_file(text):
        raise RuntimeError("text file {} formatted badly. Are you sure this was generated by the latest version of midi_to_text.py? Contents of file: \n{}".format(filename,text))
...
def song_convert(text_filename,midi_filename):
    chords = text_to_chords(text_filename,read_text_file(text_filename))
